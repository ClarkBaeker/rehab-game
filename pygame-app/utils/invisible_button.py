    ...
    def __init__(self, manager, default_button_type="", rect=None, callback=None):
        ...
        if rect: 
            ...
            if default_button_type == "back":
                self.rect = pygame.Rect(0, manager.screen_height - default_button_height, default_button_width, default_button_height)  # Bottom-left arrow
            if default_button_type == "forward":
                self.rect = pygame.Rect(manager.screen_width - default_button_width, manager.screen_height - default_button_height, default_button_width, default_button_height)
